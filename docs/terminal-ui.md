...
**Top bar focus and filtering.** When no task is focused (empty task list, or after `Shift+↑` from a focused task), the bar takes focus. From the bar:
...
- `Shift+↓` moves focus into the first visible task.
